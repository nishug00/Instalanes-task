...
a galley of type and scrambled it to make a type specimen book.</div>
        ...
        {/* Delivery */} <div className="delivery"> <table className="mini"> <thead> <tr className="title-row"> <td colSpan="4">Delivery details | For Consignee use only</td> </tr> <tr> <th>CONSIGNEE REMARKS</th> <th>CONSIGNMENT STATUS</th> <th>DELIVERY RECEIVED BY</th> <th>RECEIVER'S SIGN</th> </tr> </thead> <tbody> <tr> <td>Boxes received on time</td> <td></td> <td> Raghav Patel <br /> +91 7045737374 <br /> raghav.patel@yopmail.com <br /> department | designation </td> <td> <br /> OTP VERIFIED <br /> 01-04-2025 08:15 pm </td> </tr> </tbody> </table> </div>
